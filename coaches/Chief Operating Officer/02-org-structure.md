# 02 — Org Structure Design

Deliverable: **Org chart + role specifications (.md / table / .xlsx)**
...
The company is scaling and the current structure is breaking. The candidate must design an org structure: teams, reporting lines, key roles, and what to hire next.
...
- `Scenario: post-merger / hypergrowth / cost-cutting / remote-first.`
- `Headcount: from 15 to 60 in 12 months.`
- `Add a problematic founder or duplicated roles to untangle.`
- `Force a budget cap that requires cuts.`
