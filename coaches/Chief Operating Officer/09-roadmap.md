...
Deliverable: **Quarterly roadmap (.md / table / .xlsx)**
...
There are 20 competing priorities and no plan. The candidate must build a prioritized quarterly roadmap with rationale, sequencing, and what they deliberately said NO to.
...
- `Horizon: next quarter vs next 12 months.`
- `Add a forced trade-off: not enough engineers for everything.`
- `Require a prioritization framework (RICE / ICE / value-effort).`
- `Add a surprise external deadline mid-quarter.`
