...
Deliverable: **Diagnostic report (.md / .docx)**
...
The CEO suspects the operations are leaking money and time but doesn't know where. The candidate must produce an audit: what they'd inspect, what they found (invented), the top issues, and a fix plan.
...
- `Focus: ops / finance / hiring / customer churn / tooling.`
- `Give messy invented data the candidate must interpret.`
- `Require prioritized findings (impact vs effort).`
- `Add a 30-day quick-win section requirement.`
