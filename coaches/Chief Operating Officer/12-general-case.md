...
Deliverable: **Mixed deliverable (candidate chooses)**
...
Give an open, vague business problem with no obvious 'correct' deliverable. The candidate must choose the right artifact themselves, justify the choice, and produce it. This tests judgement, not template-filling.
...
- `Vagueness level: very vague ('something feels broken in ops, fix it').`
- `Withhold info so the candidate must state assumptions.`
- `Require them to justify why they picked that deliverable.`
- `Add a curveball follow-up the CEO asks after submission.`
