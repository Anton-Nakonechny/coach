...
Deliverable: **Spreadsheet financial model (.xlsx)**
...
The CEO needs numbers to make a decision (new hire, new market, pricing change). The candidate must build a simple financial model with assumptions, scenarios, and a recommendation.
...
- `Decision: hire 5 people / launch in a new country / change pricing / build vs buy.`
- `Require 3 scenarios: base / optimistic / pessimistic.`
- `Add a break-even or runway question.`
- `Force assumptions to be explicit and editable.`
