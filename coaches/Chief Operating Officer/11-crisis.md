...
Something is on fire RIGHT NOW (a key client threatens to leave, a system is down, a launch failed, a teammate quit mid-project). The candidate must produce a decision memo under pressure: situation, options, recommendation, immediate actions.
...
- `Crisis type: client churn / outage / PR issue / key person quit / cash crunch.`
- `Tighten the clock: 20-minute response required.`
- `Force a recommendation despite incomplete information.`
- `Add a communication plan (internal + external) requirement.`
