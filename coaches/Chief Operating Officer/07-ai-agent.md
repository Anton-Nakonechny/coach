...
Deliverable: **Agent architecture spec (.md + diagram)**
...
The company wants to replace a repetitive knowledge-work task with an AI agent. The candidate must design the agent: goal, inputs, tools, guardrails, human-in-the-loop, and success metric.
...
- `Use case: customer support / SEO content / research / QA / ops monitoring.`
- `Require guardrails + a human-review step.`
- `Add cost/latency constraint.`
- `Seniority: senior = multi-agent system with handoffs.`
