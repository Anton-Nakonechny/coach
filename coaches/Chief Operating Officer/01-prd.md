...
Deliverable: **Product Requirements Document (.md or .docx)**
...
Pick a product or internal tool the company urgently needs. The candidate must produce a PRD that an engineering team could start building from.
...
- `Make it AMBIGUOUS: give a one-line feature idea and force the candidate to define scope themselves.`
- `Industry: pick fintech / healthtech / e-commerce / B2B SaaS / marketplace.`
- `Seniority: junior = clear feature; senior = strategic bet with unclear ROI.`
- `Add constraint: must ship in 2 weeks with 1 engineer.`
