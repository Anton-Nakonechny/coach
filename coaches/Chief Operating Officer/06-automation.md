# 06 — Automation Design

Deliverable: **Automation specification (.md + diagram/table)**
...
A manual operational workflow eats too many hours. The candidate must design an automation: trigger, steps, tools, fallbacks, and the expected hours saved.
...
- `Workflow: lead routing / invoicing / reporting / data entry / customer follow-up.`
- `Tool stack: no-code (Zapier/Make) vs scripts vs AI agent.`
- `Require an ROI estimate (hours and money).`
- `Add a failure-mode/edge-case requirement.`
